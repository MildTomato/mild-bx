...
This page covers the most common authorization patterns you'll need. Each example shows what you want to achieve and the rules to make it happen.

## User Owns Their Data

The simplest pattern: users can only see their own records.
...
Users can see data in organizations they belong to.

First, define which orgs each user can access:
...
Same pattern works for teams, projects, or any entity:
...
For inserts, you typically want to ensure users can only create records in orgs/teams they belong to, and that they're recorded as the creator.

Combine multiple conditions to validate the insert:
...
Restrict deletes to the record owner:
