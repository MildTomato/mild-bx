        ...
        <div>
          <div
            ...
            className={`select-none cursor-pointer ${
              isSelected ? `bg-primary/10 ${selectionStyle}` : "text-foreground"
            } px-1`}
              ...
              {item.children ? (
                <div className="flex items-center gap-2 flex-1 group">
                  ...
                  {selectedCount !== null && selectedCount > 0 && (
                    <Badge
                      variant="secondary"
                      className="mr-2 bg-primary/10 hover:bg-primary/10"
                    >
...
export default function TreeView({
  ...
  return (
    <div className="flex gap-4">
      <div
        ref={treeRef}
        className="bg-background p-4 rounded-xl border space-y-4 w-full relative"
      >
