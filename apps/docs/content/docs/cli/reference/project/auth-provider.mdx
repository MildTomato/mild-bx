...
| Command | Description |
|---------|-------------|
| [`list`](/docs/cli/reference/auth-provider/list) | List all OAuth providers and their status |
| [`add`](/docs/cli/reference/auth-provider/add) | Configure an OAuth provider |
| [`enable`](/docs/cli/reference/auth-provider/enable) | Enable an OAuth provider |
| [`disable`](/docs/cli/reference/auth-provider/disable) | Disable an OAuth provider |
